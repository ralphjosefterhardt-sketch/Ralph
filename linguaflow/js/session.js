...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function sendChatMessage() {
    ...
    msgEl.innerHTML = `<div class="chat-sender">${senderName}</div><div class="chat-bubble">${escapeHtml(text)}</div>`;
    ...
    setTimeout(() => {
      ...
      trainerMsg.innerHTML = `<div class="chat-sender">Ralph Terhardt</div><div class="chat-bubble">${reply}</div>`;
  ...
  function initChat() {
    ...
    initialMessages.forEach(msg => {
      ...
      el.innerHTML = `<div class="chat-sender">${msg.sender}</div><div class="chat-bubble">${msg.text}</div>`;
