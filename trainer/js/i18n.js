...
const Translations = {
  de: {
    ...
    'about.p1': 'Hallo! Ich bin Ralph Terhardt – zertifizierter Sprachtrainer mit über 8 Jahren Erfahrung im Online- und Präsenzunterricht. Ich helfe Menschen dabei, Sprachen nicht nur zu lernen, sondern wirklich zu sprechen – mit Selbstsicherheit und Freude.',
    'about.p2': 'Mein Unterrichtsansatz verbindet klassische Methodik mit modernen Technologien: KI-gestützte Ausspracheanalyse, interaktive Materialien und eine warme, unterstützende Lernumgebung, in der Fehler willkommen sind.',
    ...
    'test.2.text': '„Ich lerne seit 6 Monaten Französisch bei Ralph und bin beeindruckt, wie schnell meine Fortschritte sind. Die Stunden sind immer abwechslungsreich und ich freue mich jedes Mal drauf."',
    'test.2.name': 'Felix Krause',
    'test.2.sub': 'Französisch A2 → B1 · Hamburg',
    'test.3.text': '„Für mein Job-Interview auf Englisch hat mir Ralph in nur 4 Wochen so viel gebracht. Das Buchungssystem ist super einfach, und die Video-Qualität ist immer top. Klare Empfehlung!"',
  ...
  en: {
    ...
    'feat.1.p': 'Personal 1:1 lessons directly in your browser – no app download needed. HD video, clear audio and interactive materials.',
    'feat.2.title': 'AI Pronunciation Analysis',
    'feat.2.p': 'Our AI listens to you, analyses your pronunciation in real time and shows you exactly which sounds to improve.',
    'feat.3.title': 'Flexible Scheduling',
    'feat.3.p': 'Book lessons whenever it suits you – mornings, evenings or weekends. Easy online booking in minutes.',
    'feat.4.title': 'Track Your Progress',
    'feat.4.p': 'Detailed reports after every lesson. See exactly how your vocabulary, grammar and pronunciation are growing.',
    'feat.5.title': 'Homework & Exercises',
    'feat.5.p': 'Tailor-made tasks between lessons, matched to your level and learning goals.',
    'feat.6.title': 'Free Trial Lesson',
    'feat.6.p': 'See for yourself! Book your first lesson for free and experience how effective the LinguaFlow system is.',

    'about.tag': 'About me',
    'about.h2': 'Your trainer for English &amp; French',
    'about.p1': 'Hi! I\'m Ralph Terhardt – a certified language trainer with over 8 years of experience in online and in-person teaching. I help people not just learn languages, but truly speak them – with confidence and joy.',
    'about.p2': 'My teaching approach combines classical methodology with modern technology: AI-powered pronunciation analysis, interactive materials and a warm, supportive learning environment where mistakes are welcome.',
    'about.p3': 'Whether you\'re learning for travel, work, an exam or simply out of passion – I adapt my lessons to your goals and your lifestyle.',
    ...
    'test.1.text': '"Ralph helped me pass my IELTS test with Band 8.0. His method is very structured, yet genuinely fun. The AI pronunciation analysis is an absolute game changer!"',
    'test.1.name': 'Lena Müller',
    'test.1.sub': 'English B2 → C1 · Munich',
    'test.2.text': '"I\'ve been learning French with Ralph for 6 months and I\'m amazed at how fast my progress is. The lessons are always varied and I look forward to every one."',
    'test.2.name': 'Felix Krause',
    'test.2.sub': 'French A2 → B1 · Hamburg',
    'test.3.text': '"Ralph helped me so much in just 4 weeks preparing for my English job interview. The booking system is super easy and the video quality is always great. Highly recommend!"',
    'test.3.name': 'Sarah Beck',
    ...
    'footer.desc': 'Your platform for online language lessons in English and French. Personal, modern and effective.',
  ...
  fr: {
    ...
    'feat.p': 'Apprentissage moderne combiné à un suivi personnalisé – pour des résultats concrets.',
    'feat.1.title': 'Cours vidéo en direct',
    'feat.1.p': 'Cours particuliers 1:1 directement dans votre navigateur – sans téléchargement. Vidéo HD, audio clair et supports interactifs.',
    'feat.2.title': 'Analyse de prononciation par IA',
    'feat.2.p': 'Notre IA vous écoute, analyse votre prononciation en temps réel et vous indique exactement quels sons améliorer.',
    'feat.3.title': 'Réservation flexible',
    'feat.3.p': 'Réservez des cours quand vous le souhaitez – matin, soir ou week-end. Réservation en ligne simple en quelques minutes.',
    'feat.4.title': 'Suivre sa progression',
    'feat.4.p': 'Rapports détaillés après chaque cours. Voyez exactement comment votre vocabulaire, votre grammaire et votre prononciation progressent.',
    'feat.5.title': 'Devoirs & exercices',
    'feat.5.p': 'Exercices personnalisés entre les cours, adaptés à votre niveau et à vos objectifs d\'apprentissage.',
    'feat.6.title': 'Cours d\'essai gratuit',
    'feat.6.p': 'Jugez par vous-même ! Réservez votre premier cours gratuitement et découvrez l\'efficacité du système LinguaFlow.',

    'about.tag': 'À propos de moi',
    'about.h2': 'Votre formateur en anglais &amp; français',
    'about.p1': 'Bonjour ! Je suis Ralph Terhardt – formateur en langues certifié avec plus de 8 ans d\'expérience dans l\'enseignement en ligne et en présentiel. J\'aide les gens non seulement à apprendre des langues, mais à vraiment les parler – avec confiance et plaisir.',
    'about.p2': 'Mon approche pédagogique combine méthodologie classique et technologies modernes : analyse de prononciation par IA, supports interactifs et un environnement d\'apprentissage chaleureux où les erreurs sont les bienvenues.',
    'about.p3': 'Que vous appreniez pour un voyage, le travail, un examen ou simplement par passion – j\'adapte les cours à vos objectifs et à votre quotidien.',
    ...
    'test.1.text': '« Ralph m\'a aidé à obtenir un Band 8.0 à mon test IELTS. Sa méthode est très structurée tout en étant vraiment amusante. L\'analyse de prononciation par IA est un vrai game changer ! »',
    'test.1.name': 'Lena Müller',
    'test.1.sub': 'Anglais B2 → C1 · Munich',
    'test.2.text': '« J\'apprends le français avec Ralph depuis 6 mois et je suis impressionné par la rapidité de mes progrès. Les cours sont toujours variés et j\'ai hâte d\'y être à chaque fois. »',
    'test.2.name': 'Felix Krause',
    'test.2.sub': 'Français A2 → B1 · Hambourg',
    'test.3.text': '« Ralph m\'a apporté énormément en seulement 4 semaines pour préparer mon entretien d\'embauche en anglais. Le système de réservation est super simple et la qualité vidéo est toujours parfaite. Je recommande vivement ! »',
    'test.3.name': 'Sarah Beck',
    ...
    'footer.desc': 'Votre plateforme de cours de langue en ligne en anglais et en français. Personnel, moderne et efficace.',
